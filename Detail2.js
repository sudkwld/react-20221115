...
function Detail2(props) {
  ...
  let selproduct = props.furniture.find((x) => x.id == id)
      ...
      <div className={'start ' + fade2} id='detail-screen'>
        <div className="product-section">
          <div className="product-left">
            <img src={selproduct.imgUrl1} width="70%" />
          </div>
        ...
        <div className="product-tab-content">
          <Nav variant="tabs" defaultActiveKey="link0">
            <Nav.Item >
              <Nav.Link id='sub-tab' onClick={() => { setSellect(0) }} eventKey="link0">Description</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link id='sub-tab' onClick={() => { setSellect(1) }} eventKey="link1">Additional Information</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link id='sub-tab' onClick={() => { setSellect(2) }} eventKey="link2">Reviews (2) </Nav.Link>
            </Nav.Item>
          </Nav>
        </div>
      </div>

      <TabContent sellect={sellect} />
